// #define _CRT_SECURE_NO_WARNINGS // stb_image_write compile error fix -> Properties
...
void D3D11Utils::CreateComputeShader(ComPtr<ID3D11Device> &device,
                                     const wstring &filename,
...
void D3D11Utils::CreateStructuredBuffer(ComPtr<ID3D11Device> &device,
                                        const UINT numElements,
                                        const UINT sizeElement,
                                        const void *initData,
                                        ComPtr<ID3D11Buffer> &buffer,
